...
export const translations = {
  fr: {
    ...
    settings: {
      ...
      configSubtitle: 'Configuration de OneStock',
    },
    ...
    stats: {
      ...
      addPairs: 'Ajoute des paires pour voir tes statistiques',
      avgDuration: 'Durée moyenne en stock',
      days: 'jours',
      avgDurationSub: 'Temps moyen entre achat et vente',
      rotation: 'Rotation (30 derniers jours)',
      rotationSub: 'Nombre de paires vendues ce mois',
      monthlyPurchases: 'Achats mensuels',
      purchases: 'Achats',
      salesChart: 'Vente',
      salesLabel: 'Ventes',
      profit: 'Profit',
      byBrand: 'Par marque',
      pairs: 'Paires',
      platforms: 'Plateformes de vente',
      noSalesRecorded: 'Aucune vente enregistrée',
      top5: 'Top 5 meilleures ventes',
      size: 'Taille',
    ...
    common: {
      ...
      yes: 'Oui',
      no: 'Non',
      deleteMessage: 'Cette action est irréversible. Toutes les données de cette paire seront définitivement supprimées.',
  ...
  en: {
    ...
    settings: {
      ...
      currency: 'Currency',
      notifications: 'Notifications',
      configSubtitle: 'OneStock configuration',
    },
    ...
    stats: {
      ...
      noData: 'No data yet',
      addPairs: 'Add pairs to see your statistics',
      avgDuration: 'Average stock duration',
      days: 'days',
      avgDurationSub: 'Average time between buy and sell',
      rotation: 'Rotation (last 30 days)',
      rotationSub: 'Pairs sold this month',
    ...
    common: {
      ...
      yes: 'Yes',
      no: 'No',
      deleteMessage: 'This action is irreversible. All data for this pair will be permanently deleted.',
      deleteButton: 'Delete',
      cancelButton: 'Cancel',
    },
  },
